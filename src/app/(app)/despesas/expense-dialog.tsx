...
import { createExpense, updateExpense } from "@/server/transactions/actions";
import {
  createExpenseSchema,
...
// Modo texto (comma) para os campos monetários prefilados na edição.
...
export function ExpenseDialog({
  ...
  const form = useForm<CreateExpenseInput>({
    ...
    defaultValues: {
      ...
      plannedAmount: toInputMoney(transaction?.plannedAmount),
  ...
  const body = (
    <DialogContent className="max-h-[90svh] overflow-y-auto">
      <DialogHeader>
        ...
        <DialogDescription>
          {isEdit
            ? "Ajuste os dados previstos. O valor já realizado, se houver, é preservado."
            : "Única, recorrente ou parcelada. Dados de pagamento (Pix, boleto, banco) são opcionais e ficam mascarados na listagem."}
        </DialogDescription>
      </DialogHeader>
      <form
